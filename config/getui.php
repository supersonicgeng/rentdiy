...
return [
    // APP_EVN
    'app_env' => env('APP_GT') == 'production' ? 'production' : 'development',
    ...
    'development' => [
        'client_1' => [
            'gt_appid' => env('GT_APPID'),
            'gt_appkey' => env('GT_APPKEY'),
            'gt_appsecret' => env('GT_APPSECRET'),
            'gt_mastersecret' => env('GT_MASTERSECRET'),
