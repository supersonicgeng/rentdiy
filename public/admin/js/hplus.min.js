...
function SmoothlyMenu() {
    ...
    if($(".navbar-minimalize").find('.fa').hasClass('fa-backward')){
        $(".navbar-minimalize").find('.fa').removeClass('fa-backward').addClass('fa-forward');
    }else{
        $(".navbar-minimalize").find('.fa').removeClass('fa-forward').addClass('fa-backward');
    }
}
