...
<head>
    ...
    <style>
        ...
        .list-box>.rankingList:last-child{
            border:none;
            margin-bottom:1rem;
            overflow:auto;
        }
        ...
        .over-box>.rankingList:last-child{
            /*border:none;*/
        }
        .num-bg{
            color:#fff;
...
<script>
    ...
    var user_id = {{$passport_id}};
    var u = "{{url('/wap/gameInfo',['passport_id' =>'passportId','user_id' => 'userId'])}}";
    u = u.replace('passportId',passport_id).replace('userId',user_id);
    function getList(){
    loading = true;
    $.ajax({
        url:u,
