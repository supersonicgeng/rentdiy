        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="wxSetForm" method="post" action="{{url('imgGenerate')}}">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">水印图：</label>
                            <div class="col-sm-8">
                    ...
                    <script>
                        ...
                        function uploadSuccess(file,response){
                            ...
                            $("[name=logo]").val(response.img);
                        }
                        $("#filePicker").imgUpload('选择','logo',uploadSuccess);
