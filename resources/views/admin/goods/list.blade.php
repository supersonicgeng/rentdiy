...
@endsection
@section('btn')
    <a href="{{url('manage/goodsAdd')}}" class="btn btn-white btn-sm"><i class="fa fa-plus"></i>新增</a>
@endsection
@section('action')
    {{url('manage/goods')}}
@endsection
@section('form_content')
    <div class="col-md-2">
        <div class="input-group">
            ...
            <input type="text" name="title" placeholder="请输入名称模糊查询" class="input-sm form-control">
        </div>
    </div>
    <div class="col-md-3">
        <div class="input-group">
