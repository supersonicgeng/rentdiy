...
@endsection
@section('btn')
    <a href="{{url('manage/wishAdd')}}" class="btn btn-white btn-sm"><i class="fa fa-plus"></i>新增</a>
    <a href="{{url('manage/wishExport')}}" class="btn btn-white btn-sm"><i class="fa fa-download"></i>Excel导出</a>
    <a href="javascript:;" class="btn btn-white btn-sm excel" url="{{url('manage/wishImport')}}"><i class="fa fa-upload"></i>Excel导入</a>
@endsection
@section('action')
    {{url('manage/wishList')}}
@endsection
