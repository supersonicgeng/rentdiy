                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input id="cover" type="hidden" name="figure1" value="{{$figure->figure1}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <img id="cover_show" data-action="zoom" src="{{$figure->figure1}}" alt=""
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-7">
                                            <img id="cover_show1" data-action="zoom" src="{{$figure->figure2}}" alt=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <ul class="mailbox-attachments clearfix1">
                                                @foreach(explode(',',$figure->imgs1) as $img)
                                                    <li>
                                                    <span class="mailbox-attachment-icon has-img"><img class="img_g"
                                                                                                       src="{{$img}}"
                                                                                                       alt="Attachment"></span>
                                                        <input type="hidden" name="imgs1[]" value="{{$img}}">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-7">
                                            <ul class="mailbox-attachments clearfix2" id="items">
                                                @foreach(explode(',',$figure->imgs2) as $img)
                                                    <li>
                                                    <span class="mailbox-attachment-icon has-img"><img class="img_g"
                                                                                                       src="{{$img}}"
                                                                                                       alt="Attachment"></span>
                                                        <input type="hidden" name="imgs2[]" value="{{$img}}">
                                                        <div class="mailbox-attachment-info">
                                                            <a href="javacript:void(0);"
                                                               class="mailbox-attachment-name del_son"><i
                                                                        class="fa fa-close"></i></a>
