                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="share_amt" value="{{$screen->version}}" placeholder="" type="text" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <ul class="mailbox-attachments clearfix1" id="items">
                                                @foreach(explode(',',$screen->imgs1) as $img)
                                                    <li>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <ul class="mailbox-attachments clearfix2" id="items1">
                                                @foreach(explode(',',$screen->imgs2) as $img)
                                                    <li>
                                                    <span class="mailbox-attachment-icon has-img"><img class="img_g"
                                                                                                       src="{{$img}}"
                                                                                                       alt="Attachment"></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="is_on" value="0" @if($screen->is_on ==0)checked @endif>&nbsp否&nbsp&nbsp
                                        </label>
                                    </div>
    ...
    <script>
        $(function () {
            ...
            $('.submits').click(function () {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{route('profit.screen.update',$screen->id)}}",
                    data: data,
                    dataType: 'json',
