                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" name="title" value="{{$instruction->title ?? ''}}" type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <textarea name="content" id="" cols="100" rows="10" required>{{$instruction->content ?? ''}}</textarea>
