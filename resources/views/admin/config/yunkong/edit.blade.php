...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" method="post" action="{{route('profit.iosc.update',$ios->id)}}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="version" placeholder=""
                                                   value="{{$ios->version}}"
                                                   type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            ...
                                            <input type="radio" name="is_on" value="0" @if($ios->is_on == 0) checked @endif>&nbsp否
                                        </label>
                                    </div>
