...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" method="POST" action="{{route('profit.ad.store')}}">
                        @csrf
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">广告名称<span style="color: red;">&nbsp*</span></label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="title" value="{{old('title')}}"  placeholder="广告名称" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input id="cover" type="hidden" name="image1" value="{{old('image1')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <img id="cover_show" data-action="zoom" src="{{old('image1')}}" alt=""
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-7">
                                            <img id="cover_show1" data-action="zoom" src="{{old('image2')}}" alt=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" name="sort" value="55" placeholder="值越大排序越靠前" type="text">
                                    ...
                                    <div class="form-group" id="zt" style="display: none">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="margin-bottom">
                                                <button data-url="{{route('common.special.index')}}" data-title="选择专题" type="button"
                                    ...
                                    <div class="form-group" id="wy" style="display: none">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" name="url" value="{{old('url')}}" placeholder="" type="text">

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">生效起始时间<span style="color: red;">&nbsp*</span></label>
                                        <div class="col-sm-5">
                                            <input class="form-control" id="_time_from" name="start_at" value="{{old('start_at')}}" placeholder="" type="text" required>

                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">生效结束时间<span style="color: red;">&nbsp*</span></label>
                                        <div class="col-sm-5">
                                            <input class="form-control" id="_time_to" name="stop_at" value="{{old('stop_at')}}" placeholder="" type="text" required>
