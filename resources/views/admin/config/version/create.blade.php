                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input id="cover" type="hidden" name="image" value="{{old('image')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <img id="cover_show"
                                                 src="{{old('image')?old('image'):'/avatar.png'}}" alt=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="android_apk" placeholder="" value="{{old('android_apk')}}"
                                                   type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="ios_store_apk" placeholder="" value="{{old('ios_store_apk')}}"
                                                   type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="ios_apk" placeholder="" value="{{old('ios_apk')}}"
                                                   type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="compel" value="1" >&nbsp是&nbsp&nbsp
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <textarea name="des" placeholder="介绍不超过150个字" cols="80" rows="5">{{old('des')}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="is_maintain" value="1" >&nbsp是&nbsp&nbsp
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="_time_from" name="main_created" placeholder="不维护可不填写" value="{{old('main_created')}}"
                                                   type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="_time_to" name="main_end" placeholder="不维护可不填写" value="{{old('main_end')}}"
                                                   type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <textarea name="maintain_des" placeholder="不维护可不填写" cols="80" rows="5">{{old('maintain_des')}}</textarea>
    ...
    <script>
        $(function () {
            ...
            $('.submits').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('profit.version.store')}}",
                    data: data,
                    dataType: 'json',
