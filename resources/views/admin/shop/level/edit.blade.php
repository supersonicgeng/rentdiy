        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="edit_form" method="post" action="{{url('manage/edit_level',[$info->id])}}">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">等级级别：</label>
                            <div class="col-sm-2">
                                <input name="level" class="form-control" type="text" value="{{$info->level}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">等级名称：</label>
                            <div class="col-sm-2">
                                <input name="level_name" class="form-control" type="text" value="{{$info->level_name}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">最低积分：</label>
                            <div class="col-sm-2">
                                <input name="min_score" class="form-control" type="text" value="{{$info->min_score}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">最高积分：</label>
                            <div class="col-sm-2">
                                <input name="max_score" class="form-control" type="text" value="{{$info->max_score}}">
                            </div>
                        </div>
                        <div class="form-group">
