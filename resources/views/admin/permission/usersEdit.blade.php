        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="wxSetForm" method="post" action="{{url('manage/usersEdit',[$info->id])}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input name="email" class="form-control" type="text" value="{{@$info->email}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select id="passport" name="passport_id">
                                    <option selected value="{{$info->passport->passport_id}}">{{$info->passport->nickname}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="role_id">
                                    @foreach($roles as $role)
                                        <option value="{{$role->id}}"  @if($role->id == $info->roles[0]->id) selected @endif >{{$role->display_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
