...
<div class="wrap">
    <div class="top-box">
        ...
        <div class="ranking-list-top flex-justify-around">
            <div class="flex-items-end">
                <a href="{{url('/gameInfo',['passport_id'=>$Top3[1]->passport_id])}}">
                <div>
            ...
            <div class="flex-items-end">
                <a href="{{url('/gameInfo',['passport_id'=>$Top3[0]->passport_id])}}">
                <div>
                    <div class="text-center ranking-list-img-box">
            ...
            <div class="flex-items-end">
                <a href="{{url('/gameInfo',['passport_id'=>$Top3[2]->passport_id])}}">
                <div>
                    <div class="text-center ranking-list-img-box">
    ...
    <div class="btn-box">
        <a href="javascript:;">
            <img src="/game/image/scoresRanking/32.png" alt="">
        </a>
        <a href="javascript:;">
            <img src="/game/image/scoresRanking/33.png" alt="">
        </a>
    </div>
    <!--小汽车-->
    <div class="car">
