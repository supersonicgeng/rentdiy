...
<style>
    ...
    .wrap{
        background:url("/game/image/loading/03.png") no-repeat center 30%,url("/game/image/01.png") no-repeat 0 0;
...
<div class="loading-box">
    ...
    <div class="loading-font text-center">
        loading<span class="load-font">.</span><span class="load-font">.</span><span class="load-font">.</span>
    </div>
...
<script>
    ...
    load(2000,function(){
        window.location.href="{{url('game',['share_passport_id'=>$share_passport_id,'passport_id'=>$passport_id])}}";
    });
