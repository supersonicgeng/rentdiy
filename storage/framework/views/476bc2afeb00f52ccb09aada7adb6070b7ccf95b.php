                                ...
                                <form>
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="_time_from" name="start_time"
                                               ...
                                               placeholder="下单查询开始日期" type="text" autocomplete="off">
                                        <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
                                        <input class="form-control" id="_time_to" name="end_time" style="width: 157px"
                                               value="<?php echo e(Request::input('end_time')); ?>"
                                               placeholder="下单查询结束日期" type="text" autocomplete="off">
                                    </div>
                                    <div class="input-group">
                                        <input class="form-control" id="_del_from" name="_del_from"
                                               value="<?php echo e(Request::input('_del_from')); ?>" style="width: 157px"
                                               placeholder="结算查询开始日期" type="text" autocomplete="off">
                                        <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
                                        <input class="form-control" id="_del_to" name="_del_to" style="width: 157px"
                                               value="<?php echo e(Request::input('_del_to')); ?>"
                                               placeholder="结算查询结束日期" type="text" autocomplete="off">
                                    </div>
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>效果预估<?php echo table_sort('pub_share_pre_fee'); ?></th>
                                    <th>预估收入<?php echo table_sort('commission'); ?></th>
                                    <th>用户ID</th>
                                ...
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($order->alipay_total_price ? $order->alipay_total_price:'0.00'); ?></td>
                                        <td><?php echo e($order->item_num); ?></td>
                                        <td><?php echo e($order->total_commission_rate); ?></td>
                                        <td><?php echo e($order->pub_share_pre_fee ? $order->pub_share_pre_fee:'0.00'); ?></td>
                                        <td><?php echo e($order->commission ?? '0.00'); ?></td>
                                        <td><?php echo e($order->customer_id_when_buy ?? 'null'); ?></td>
                                        <td><?php echo e($order->v1_p ?? '0.00'); ?></td>
                                        <td><?php echo e($order->v2 ? $order->v2:'/'); ?></td>
                                        <td><?php echo e($order->v2_p ?? '0.00'); ?></td>
                                        <td><?php echo e($order->v3 ? $order->v3:'/'); ?></td>
                                        <td><?php echo e($order->v3_p ?? '0.00'); ?></td>
                                        <td><?php echo e($order->v4 ? $order->v4:'/'); ?></td>
                                        <td><?php echo e($order->v4_p ?? '0.00'); ?></td>
                                        <td><?php echo e($order->platform_p ?? '0.00'); ?></td>
                                        <td>
                                        ...
                                        <td><?php echo e($order->earning_time); ?></td>
        ...
        $(function () {
            ...
            $('.dc_excel').click(function () {
                ...
                location.href = '/admin/order/goods/export?search_field=' + d.search_field + '&_sort=' + d._sort + '&keyword='
                    + d.keyword + '&tk_status=' + d.tk_status + '&order_type='
                    + d.order_type + '&cate_id=' + d.cate_id + '&start_time=' + d.start_time + '&end_time=' + d.end_time + '&_del_from=' + d._del_from + '&_del_to=' + d._del_to;
            })
        })
    </script>
<?php $__env->stopSection(); ?>
