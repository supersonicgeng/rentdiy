                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="name" placeholder="名称最多6个字" value="<?php echo e(old('name')); ?>"
                                                   type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="sort" value="<?php echo e(old('sort')?old('sort'):55); ?>"
    ...
    <script>
        $(function () {
            ...
            $('.submits').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('material.category.store')); ?>",
                    data: data,
                    dataType: 'json',
