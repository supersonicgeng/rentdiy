                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php $__currentLoopData = $specials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo is_something('is_fy',$s); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if($s->is_and !=1): ?>
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('shop.special.goods',$s->id)); ?>"><i class="fa fa-edit"></i> 进入商品库</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
