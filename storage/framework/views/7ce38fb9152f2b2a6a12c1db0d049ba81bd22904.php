                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">超级Vip开始时间</label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">超级Vip结束时间</label>
                                    <div class="col-sm-5">
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        $('.submits').click(function () {
            ...
            $.ajax({
                type: 'PUT',
                url: '<?php echo e(route('platform.customer.setSuperVip',$customer->id)); ?>',
                data: data,
                dataType: 'json',
