                                ...
                                <form>
                                    <div class="input-daterange input-group input-group-sm">
                                        <select class="form-control" name="user_type">
                                            ...
                                            <option value="1" <?php if(Request::input('user_type') == 1): ?> selected <?php endif; ?>>淘宝</option>
                                            <option value="2" <?php if(Request::input('user_type') == 2): ?> selected <?php endif; ?>>天猫</option>
                                        </select>
                                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if($good): ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($good->category_name); ?></td>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-xs"
                                               href="<?php echo e(route('shop.product.warehouse',['item_url'=>$good->item_url])); ?>"><i class="fa fa-edit"></i> 编辑入库</a>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                                </tbody>
