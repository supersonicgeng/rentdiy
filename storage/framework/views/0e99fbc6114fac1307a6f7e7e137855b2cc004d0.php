                                ...
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">封面图<span
                                                    style="color: red;">&nbsp*</span></label>
                                        <div class="col-sm-7">
                                            <input id="cover" type="hidden" name="cover" value="<?php echo e(old('cover')); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <img data-action="zoom" id="cover_show"
                                                 src="<?php echo e(old('cover') ?old('cover'):'/avatar.png'); ?>" alt=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="sort"
                                                   value="<?php echo e(old('sort')?old('sort'):55); ?>"
    ...
    <script>
        $(function () {
            ...
            $('.submits').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('material.article.store')); ?>",
                    data: data,
                    dataType: 'json',
