...
<div class="login-box">
    <div class="login-logo"><a href="javascript:;">聚好麦</a></div>
    <div class="login-box-body">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST">
            ...
            <div class="row form-group">
                <div class="col-xs-6"><input class="form-control" name="captcha" placeholder="验证码"></div>
                <div class="col-xs-4">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-danger btn-block"
                            data-loading-text="&lt;i class=&#39;fa fa-spinner fa-spin &#39;&gt;&lt;/i&gt; 登录">登录
                    </button>
                </div>
            </div>
        </form>
