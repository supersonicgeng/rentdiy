<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('operate.locate.update',$matter->id)); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="m_title" value="<?php echo e($matter->m_title); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <textarea name="describe" cols="80" rows="10"><?php echo e($matter->describe); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            ...
                                            <input type="radio" name="is_on" value="0" <?php if($matter->is_on == 0): ?> checked <?php endif; ?>>&nbsp否
                                        </label>
                                    </div>
                                </div>
                            </div>
