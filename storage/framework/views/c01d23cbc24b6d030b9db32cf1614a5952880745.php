                                ...
                                <form>
                                    ...
                                    <div class="input-daterange input-group input-group-sm">
                                        <select class="form-control" name="member_type">
                                            ...
                                            <option value="4" <?php if(Request::input('member_type') ==4): ?> selected <?php endif; ?>>
                                                会员
                                            </option>
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>累计预估收益<?php echo table_sort('income'); ?></th>
                                ...
                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-id=<?php echo e($customer->id); ?>>
                                        ...
                                        <td><?php echo e($customer->income); ?></td>
                                        <td><?php echo e($customer->balance); ?></td>
                                        <td><?php echo e($customer->already_withdrawal); ?></td>
                                        <td><?php echo e($customer->confirmed_income); ?></td>
                                        <td><?php echo e($customer->withdraw_ing); ?></td>
                                        <td><?php echo e($customer->withdraw_month); ?></td>
                                        <td><?php echo e($customer->total_price == ''? 0:$customer->total_price); ?></td>
                                        <td><?php echo e($customer->order_nums); ?></td>
                                        ...
                                        <td><?php echo e($customer->first_fans); ?></td>
                                        <td><?php echo e($customer->second_fans); ?></td>
                                        <td>
                                        ...
                                        <td>
                                              ...
                                              <?php echo is_something('is_special',$customer); ?>
                                            ...
                                            <?php if($customer->member_type !=3): ?>
                                                <a class="btn btn-primary btn-xs check_model"
                                                   ...
                                                   data-title="升级Vip"><i
                                                    ...
                                                    设置合伙人</a>
                                            <?php endif; ?>
                                            <?php if($customer->member_type == 2): ?>
                                                <a class="btn btn-danger btn-xs del_vip" href="javascript:void(0);"
                                                   data-url="<?php echo e(route('platform.customer.del_Vip',$customer->id)); ?>"><i
                                                            class="fa fa-cut"></i> 取消合伙人</a>
                                            <?php endif; ?>
                                        </td>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $('.change').click(function () {
            ...
            $('.change_attr').click(function () {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route('platform.customer.change_attr')); ?>',
                    success: function (data) {
                        if (data.status == 1) {
                            toastr.success(data.msg);
                        } else {
        ...
        $('.del_vip').click(function () {
            var url = $(this).data('url');
            layer.confirm('您确定要取消吗?', {icon: 3, title: '提示'}, function (index) {
                $.ajax({
                    type: 'PATCH',
                    url: url,
                    success: function (data) {
        ...
        $('.dc_excel').click(function () {
            ...
            location.href='/admin/platform/customer/export?search_field='+d.search_field+'&_sort='+d._sort+'&keyword='
                +d.keyword+'&status='+d.status+'&member_type='+d.member_type+'&start_time='+d.start_time+'&end_time='+d.end_time;
        })
    </script>
<?php $__env->stopSection(); ?>
