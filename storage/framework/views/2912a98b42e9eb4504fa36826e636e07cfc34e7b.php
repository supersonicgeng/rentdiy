                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input id="cover" type="hidden" name="image" value="<?php echo e(old('image')?old('image'):$template->image); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <img  id="cover_show"
                                                 src="<?php echo e(old('image')?old('image'):$template->image); ?>" alt=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="url" placeholder="" value="<?php echo e(old('url')?old('url'):$template->url); ?>"
                                                   type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" name="sort" value="<?php echo e(old('sort')?old('sort'):$template->sort); ?>"
    ...
    <script>
        $(function () {
            ...
            $('.submits').click(function () {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('profit.template.update',$template->id)); ?>",
                    data: data,
                    dataType: 'json',
                    success: function (info) {
                        ...
                        if (info.status == 1) {
                            ...
                            setTimeout(function(){window.location="<?php echo e(route('profit.template.index')); ?>"},800);
                        } else {
