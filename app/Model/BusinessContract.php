...
class BusinessContract extends Model
{
    ...
    protected $fillable = ['id','contract_id','premises','car_parks','lease_term','term_method','commencement_date','final_expiry_date','renewal_right','renewal_time',
        ...
        'premises_condition_upload_url','notes','notes_upload_url','landlord_signature','sign_date','tenement_signature','created_at','updated_at','deleted_at'];
}
