...
class OtherRentApplication extends Model
{
    ...
    protected $fillable = ['id','tenement_id','apply_house_address','apply_start_time','apply_end_time','tenement_address','tenement_name','birthday','phone','mobile','email','welfare_no',
        'have_pets','pets','current_address','current_rent_fee','rent_times','rent_way','live_method','other_method','leave_reason','current_landlord_name','landlord_phone',
        'property_manager_name','manager_phone','manager_mobile','inform_landlord','driving_license','version_num','passport','vehicle','others','work_situation','company_name',
