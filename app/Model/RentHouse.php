...
class RentHouse extends Model
{
    ...
    protected $fillable = ['id','user_id','group_id','rent_category','propert_name','room_name','details','room_description','shower_room','property_type','bathroom_type','bathroom_no','bedroom_no','bed_no','require_rent','short_words',
        'actual_area','building_area','parking_no','garage_no','insurance_company','insurance_start_time','insurance_end_time','address','Desc','TA','Region','lat','lon','bus_station','school','supermarket',
