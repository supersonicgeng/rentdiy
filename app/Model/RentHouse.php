...
class RentHouse extends Model
{
    ...
    protected $fillable = ['id','user_id','group_id','rent_category','property_name','room_name','details','room_description','shower_room','property_type','bathroom_type','bathroom_no','bedroom_no','bed_no','require_rent','short_words',
