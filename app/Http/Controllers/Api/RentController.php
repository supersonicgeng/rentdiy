...
class RentController extends CommonController
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function rentApplicationOutPrint(Request $request)
    {
        return service('Rent')->rentApplicationOutPrint($request->all());
    }
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function litigationStart(Request $request)
    {
