...
class VerifyService
{
    ...
    {
        $this->AppKey      = env('PHONE_SMS_APPKEY', '7f65c2fead87f48c6b9ee71a8bf62b44');
        $this->AppSecret   = env('PHONE_SMS_APPSECRET', 'f546773f4a2d');
    ...
    public function getPhoneVerifyInDatabase($phone)
    {
        return VerifyLog::where('phone',$phone)->where('status',VerifyLog::$STATUS_OFF)->orderBy('send_time','desc')->value('code');
    }
}