    ...
    public function rentContactDetail(array $input)
    {
        ...
        if($res->contract_type == 1){
            $res = $model->where('rent_contract.id',$input['contract_id'])->leftjoin('contract_tenement','contract_tenement.contract_id','=','rent_contract.id')
                ->leftjoin('rent_entire_contract','rent_entire_contract.contract_id','=','id')->first();
            if($res){
            ...
            $res = $model->where('rent_contract.id',$input['contract_id'])->leftjoin('contract_tenement','contract_tenement.contract_id','=','rent_contract.id')
                ->leftjoin('rent_separate_contract','rent_separate_contract.contract_id','=','id')->first();
            if($res){
                return $this->success('get contact success',$res);
            }else{
                return $this->error('2','get contact failed');
            ...
            $res = $model->where('rent_contract.id',$input['contract_id'])->leftjoin('contract_tenement','contract_tenement.contract_id','=','rent_contract.id')
                ->leftjoin('rent_business_contract','rent_business_contract.contract_id','=','id')->first();
            if($res){
                return $this->success('get contact success',$res);
            }else{
                return $this->error('2','get contact failed');
